...
namespace WebApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(IUserService userService, IAuthService authService, IUserRelationshipService userRelationshipService, IUserThemeOptionService userThemeOptionService)
        {
        ...
        {
            var result = _userRelationshipService.GetListDto(adminUserId);
            if (result.Success)
            {
                return Ok(result);
            }
        ...
        {
            var result = _userRelationshipService.GetById(userId);
            if (result.Success)
            {
                return Ok(result);
            }
