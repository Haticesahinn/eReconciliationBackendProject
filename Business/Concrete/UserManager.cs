...
namespace Business.Concrete
{
    public class UserManager : IUserService
    {
        ...
        public UserManager(IUserDal userDal, IUserOperationClaimService userOperationClaimService, IUserCompanyService userCompanyService, IOperationClaimService operationClaimService, ICompanyService companyService, IUserRelationshipService userRelationshipService, IUserThemeOptionService userThemeOptionService)
        {
            _userDal = userDal;
        ...
        public IResult UserCompanyAdd(int userId, int companyId)
        {
            ...
            return new SuccessResult(Messages.AddedUserCompanyRelationship);
        }
        ...
        public IResult UserDelete(int userId)
        {
            ...
            var userRelationships = _userRelationshipService.GetList(userId);
            foreach (var userRelationship in userRelationships)
            {
                _userRelationshipService.Delete(userRelationship);
            }
