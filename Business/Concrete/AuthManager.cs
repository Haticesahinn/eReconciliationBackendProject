...
namespace Business.Concrete
{
    public class AuthManager : IAuthService
    {
        ...
        public AuthManager(IUserService userService, ITokenHelper tokenHelper, ICompanyService companyService, IMailParameterService mailParameterService, IMailService mailService, IMailTemplateService mailTemplateService, IUserOperationClaimService userOperarionClaimService, IOperationClaimService operarionClaimService, IUserRelationshipService userRelationshipService, IUserThemeOptionService userThemeOptionService)
        {
